...
- Understands DNS and email authentication.
- Wants a fast checker with raw records and clear status.
- May use the tool occasionally and recommend it.

## Main pain

The main pain is not “I need a DNS checker”.
...
- Keep the tool above the fold.
- Make results understandable for non-technical users.
- Keep technical details available for developers.
- Never promise inbox placement.
- Do not create SaaS complexity before validation.
